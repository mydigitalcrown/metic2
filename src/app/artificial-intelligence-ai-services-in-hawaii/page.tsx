...
export const metadata = {
  ...
  openGraph: {
    title: "Artificial Intelligence Company In Hawaii | #1 AI Company In Hawaii - Metic.ai",
    description: "Leading Artificial Intelligence Company In Hawaii with 2100+ successful AI implementations. Expert AI services, machine learning solutions & AI development for Hawaii businesses.",
