          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="text-center">  
              ...
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-300 mb-6 md:mb-8 max-w-4xl mx-auto leading-relaxed px-4">
                Looking for the <strong className="text-primary-orange">best AI Company In Alaska</strong>? Metic.ai is the premier <strong className="text-white">Artificial Intelligence Company In Alaska</strong> delivering enterprise AI solutions with proven results.
              </p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12 md:mb-16">
              ...
              <p className="text-base md:text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed px-4">
                Comprehensive artificial intelligence services from Alaska's most trusted <strong className="text-gray-900">AI Company In Alaska</strong>. 
                Transforming businesses with cutting-edge AI solutions tailored for Alaska's industrial landscape.
              </p>
            </div>
