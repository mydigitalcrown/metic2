...
export const metadata = {
  title: "AI Services Alaska | Premier Artificial Intelligence Solutions & Development - Metic.ai",
  description: "Alaska's leading AI company delivering custom artificial intelligence solutions. Expert AI development, machine learning, automation, and data analytics with 3x faster delivery and 60% cost savings for AK businesses.",
  keywords: "AI services Alaska, artificial intelligence Alaska, machine learning Alaska, AI consulting AK, AI development Alaska, custom AI solutions AK, AI automation Alaska, enterprise AI Alaska, Anchorage AI, Fairbanks AI",
  ...
  twitter: {
    ...
    title: "AI Services Alaska | Premier Artificial Intelligence Solutions & Development - Metic.ai",
    description: "Alaska's leading AI company delivering custom artificial intelligence solutions. Expert AI development, machine learning, automation, and data analytics with 3x faster delivery and 60% cost savings.",
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center gap-2 mb-6">
              ...
              <span className="text-sm font-medium text-orange-300">Serving Alaska</span>
            </div>
            
            <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl mb-6 text-white">
              AI Solutions for <span className="text-primary-orange">Alaska</span>
            </h1>
            
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Alaska businesses operate in challenging environments and need solutions that work reliably. 
              From Anchorage's logistics hubs to remote operations across the frontier, we've helped 30+ Alaska 
              companies implement AI that thrives in extreme conditions. Last frontier innovation meets smart technology.
            </p>
