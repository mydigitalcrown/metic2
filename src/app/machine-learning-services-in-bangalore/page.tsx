...
export const metadata = {
  ...
  twitter: {
    ...
    title: "#1 ML Company In Bangalore | ML Services - Metic.ai",
    description: "Leading ML Company In Bangalore. Expert machine learning development & automation services with proven results. Transform your business with ML solutions.",
