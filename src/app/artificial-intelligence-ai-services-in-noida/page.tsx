...
export const metadata = {
  title: "AI Services Noida | Top Artificial Intelligence Solutions & Consulting - Metic.ai",
  description: "Leading AI services in Noida, India. Expert artificial intelligence consulting, machine learning, custom AI development, and data analytics solutions. Transform your Noida business with cutting-edge AI technology.",
  keywords: "AI services Noida, artificial intelligence Noida, machine learning Noida, AI consulting Noida India, AI development Noida, data science Noida, AI solutions Noida, AI companies Noida UP",
  ...
  twitter: {
    ...
    description: "Transform your Noida business with expert AI services. Machine learning, custom AI development, and data analytics solutions.",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Leading AI services in Noida, India. Expert artificial intelligence consulting, machine learning, custom AI development, and data analytics solutions for Noida businesses.",
            "address": {
              "@type": "PostalAddress",
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center gap-2 mb-6">
              ...
              <span className="text-sm font-medium text-gray-600">Serving Noida, Uttar Pradesh</span>
            </div>
            
            <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl mb-6">
              AI Services in <span className="text-primary-orange">Noida</span>
            </h1>
            
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Transform your Noida business with cutting-edge artificial intelligence solutions. 
              From Sector 62 to Greater Noida, we deliver enterprise-grade AI services that drive innovation and growth 
              across India's technology hub.
            </p>
