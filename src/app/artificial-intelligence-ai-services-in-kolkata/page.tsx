    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "AI Services Kolkata - Metic.ai",
      },
    ],
  },
  twitter: {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "areaServed": [
              "Kolkata", "Salt Lake", "Park Street", "Ballygunge", "Alipore", 
              "Howrah", "New Town", "Rajarhat", "Sector V", "Bidhannagar",
              "Jadavpur", "Tollygunge", "Gariahat", "Dalhousie", "Esplanade"
            ],
            "aggregateRating": {
      ...
      <section className="py-20 bg-white">
        <div className="container px-4 md:px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl mb-6">
                Why Kolkata Businesses Choose Metic.ai
              </h2>
              <div className="w-20 h-1 bg-primary-orange mx-auto mb-8"></div>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Trusted by businesses across Kolkata for our expertise, results, and commitment to success.
              </p>
            </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
              Join leading Kolkata companies that trust Metic.ai for their AI transformation. 
