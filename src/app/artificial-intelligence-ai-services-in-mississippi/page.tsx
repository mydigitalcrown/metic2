    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "AI Services Mississippi - Metic.ai",
      },
    ],
  },
  twitter: {
    ...
    <>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "areaServed": [
              ...
              "Clinton", "Madison", "Pearl", "Ridgeland", "Starkville"
            ],
            "aggregateRating": {
      ...
      <section className="py-20 bg-primary-orange text-white">
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl mb-6">
              Ready to Transform Your Mississippi Business with AI?
            </h2>
            <p className="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
              Join leading Mississippi companies that trust Metic.ai for their AI transformation. 
            ...
            <div className="mt-12 text-center">
              <p className="text-orange-200 mb-4">Trusted by businesses across Mississippi</p>
