...
export const metadata = {
  title: "AI Services Kansas | Top Artificial Intelligence Solutions & Consulting - Metic.ai",
  description: "Leading AI services in Kansas. Expert artificial intelligence consulting, machine learning, custom AI development, and data analytics solutions. Transform your KS business with cutting-edge AI technology.",
  keywords: "AI services Kansas, artificial intelligence Kansas, machine learning Kansas, AI consulting KS, AI development Kansas, data science Kansas, AI solutions KS, AI companies Kansas",
  authors: [{ name: "Metic.ai Kansas AI Team" }],
  robots: "index, follow",
  openGraph: {
    title: "AI Services Kansas | Top Artificial Intelligence Solutions & Consulting - Metic.ai",
    description: "Leading AI services in Kansas. Expert artificial intelligence consulting, machine learning, and custom AI development solutions for KS businesses.",
    url: "https://metic.ai/artificial-intelligence-ai-services-in-kansas/",
    type: "website",
    images: [
      {
        url: "https://metic.ai/og-ai-services-kansas.jpg",
        width: 1200,
        height: 630,
        alt: "AI Services Kansas - Metic.ai",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "AI Services Kansas | Artificial Intelligence Solutions - Metic.ai",
    description: "Transform your Kansas business with expert AI services. Machine learning, custom AI development, and data analytics solutions.",
    images: ["https://metic.ai/og-ai-services-kansas.jpg"],
  },
  alternates: {
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Metic.ai - AI Services Kansas",
            "image": "https://metic.ai/logo.png",
            "description": "Leading AI services in Kansas. Expert artificial intelligence consulting, machine learning, custom AI development, and data analytics solutions for KS businesses.",
            "address": {
              "@type": "PostalAddress",
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center gap-2 mb-6">
              ...
              <span className="text-sm font-medium text-gray-600">Serving Kansas</span>
            </div>
            
            <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl mb-6">
              AI Services in <span className="text-primary-orange">Kansas</span>
            </h1>
            
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Transform your Kansas business with cutting-edge artificial intelligence solutions. 
              From Wichita to Kansas City, we deliver enterprise-grade AI services that drive innovation and growth 
      ...
      <section className="py-20 bg-primary-orange text-white">
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl mb-6">
              Ready to Transform Your Kansas Business with AI?
            </h2>
            <p className="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
              Join leading Kansas companies that trust Metic.ai for their AI transformation. 
