...
export const metadata = {
  title: "AI Services Kansas | Premier Artificial Intelligence Solutions & Development - Metic.ai",
  description: "Kansas's leading AI company delivering custom artificial intelligence solutions. Expert AI development, machine learning, automation, and data analytics with 3x faster delivery and 60% cost savings for KS businesses.",
  keywords: "AI services Kansas, artificial intelligence Kansas, machine learning Kansas, AI consulting KS, AI development Kansas, custom AI solutions KS, AI automation Kansas, enterprise AI Kansas, Wichita AI, Topeka AI",
  ...
  twitter: {
    ...
    title: "AI Services Kansas | Premier Artificial Intelligence Solutions & Development - Metic.ai",
    description: "Kansas's leading AI company delivering custom artificial intelligence solutions. Expert AI development, machine learning, automation, and data analytics with 3x faster delivery and 60% cost savings.",
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl mb-6 text-white">
              AI Solutions for <span className="text-primary-orange">Kansas</span>
            </h1>
            
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Kansas businesses value practical solutions that work. From Wichita's aviation industry to 
              agricultural operations across the plains, we've helped 65+ Kansas companies implement AI 
              that delivers results without unnecessary complexity. Sunflower state, smart solutions.
            </p>
