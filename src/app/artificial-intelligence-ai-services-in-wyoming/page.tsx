...
export const metadata = {
  title: "AI Services Wyoming | Premier Artificial Intelligence Solutions & Development - Metic.ai",
  description: "Wyoming's leading AI company delivering custom artificial intelligence solutions. Expert AI development, machine learning, automation, and data analytics with 3x faster delivery and 60% cost savings for WY businesses.",
  keywords: "AI services Wyoming, artificial intelligence Wyoming, machine learning Wyoming, AI consulting WY, AI development Wyoming, custom AI solutions WY, AI automation Wyoming, enterprise AI Wyoming, Cheyenne AI, Casper AI",
  ...
  twitter: {
    ...
    title: "AI Services Wyoming | Premier Artificial Intelligence Solutions & Development - Metic.ai",
    description: "Wyoming's leading AI company delivering custom artificial intelligence solutions. Expert AI development, machine learning, automation, and data analytics with 3x faster delivery and 60% cost savings.",
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl mb-6 text-white">
              AI Solutions for <span className="text-primary-orange">Wyoming</span>
            </h1>
            
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Wyoming businesses value independence and practical solutions. From energy operations in 
              Casper to ranching across the plains, we've helped 25+ Wyoming companies implement AI 
              that works in their rugged environment. Cowboy state spirit meets smart technology.
            </p>
