...
export const metadata = {
  ...
  description: "Leading Machine Learning Company In Oregon with 50+ successful ML implementations. Expert ML services, machine learning solutions & ML Development. Transform your business with 60% cost savings & 3x faster delivery.",
  keywords: [
