          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl mb-6">
                Machine Learning <span className="text-primary-orange">Expertise in Pune</span>
              </h2>
              <div className="w-20 h-1 bg-primary-orange mx-auto mb-8"></div>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Comprehensive machine learning services from data preparation to model deployment and monitoring for Pune businesses
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-gray-50 rounded-xl p-8 hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-600 leading-relaxed mb-6">
                  Forecast Pune market trends, customer behavior, and business outcomes using advanced predictive 
              ...
              <div className="bg-gray-50 rounded-xl p-8 hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-600 leading-relaxed mb-6">
                  Discover hidden patterns in your Pune market data using unsupervised learning techniques for market 
      ...
      <section className="py-20 bg-gray-50">
        <div className="container px-4 md:px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl mb-6">
                Machine Learning Solutions for <span className="text-primary-orange">Pune Businesses</span>
              </h2>
              <div className="w-20 h-1 bg-primary-orange mx-auto mb-8"></div>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Specialized ML solutions including Automotive analytics, IT services ML, manufacturing optimization, and education technology tailored for Pune's business environment
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  ...
                  optimized for Pune business requirements.
                </p>
              </div>
