...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://metic.ai/og-ai-services-ahmedabad.jpg",
        width: 1200,
        height: 630,
        alt: "AI Services Ahmedabad - Metic.ai",
      },
    ],
  },
  twitter: {
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "areaServed": [
              "Ahmedabad", "Satellite", "Vastrapur", "Prahlad Nagar", "Ambawadi", 
              "CG Road", "SG Highway", "Bopal", "Gota", "Chandkheda",
              "Maninagar", "Ellis Bridge", "Navrangpura", "Paldi", "GIFT City"
            ],
            "aggregateRating": {
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl mb-6">
                AI Solutions for <span className="text-primary-orange">Ahmedabad</span> Businesses
              </h2>
              <div className="w-20 h-1 bg-primary-orange mx-auto mb-8"></div>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Comprehensive artificial intelligence services designed to help Ahmedabad businesses 
      ...
      <section className="py-20 bg-white">
        <div className="container px-4 md:px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl mb-6">
                Why Ahmedabad Businesses Choose Metic.ai
              </h2>
              <div className="w-20 h-1 bg-primary-orange mx-auto mb-8"></div>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Trusted by businesses across Ahmedabad for our expertise, results, and commitment to success.
              </p>
            </div>
      ...
      <section className="py-20 bg-primary-orange text-white">
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl mb-6">
              Ready to Transform Your Ahmedabad Business with AI?
            </h2>
            <p className="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
              Join leading Ahmedabad companies that trust Metic.ai for their AI transformation. 
            ...
            <div className="mt-12 text-center">
              <p className="text-orange-200 mb-4">Trusted by businesses across Ahmedabad</p>
