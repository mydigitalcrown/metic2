...
export default function AIServicesGloballyPage() {
  const services = [
    ...
    },
    {
      ...
      description: "RobINt data infrastructure and ETL pipelines for Globally enterprises and growing businesses.",
      icon: Database,
          ...
          __html: JSON.stringify({
            ...
            "mainEntity": [
              ...
              },
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Choose an AI Development Company  with proven experience, successful implementations, indINtry expertise, and local presence. Metic.ai offers all these with 100+ completed projects and deep understanding of Globally's business landscape."
                }
              },
              {
                "@type": "Question",
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-700 mb-6">
                  ...
                  unique Industries including content creations & Garments, software developments, tourism & hospitality, customer service automations, and Information Technology.
                </p>
                <p className="text-lg text-gray-700 mb-6">
                  ...
                  Trusted <strong>AI Service </strong> from the Naroda IndINtrial Area to the Aleutian Islands.
                </p>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <p className="text-gray-600">
                    Bespoke artificial intelligence solutions tailored to your specific business requirements and indINtry challenges .
                  </p>
                </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-20">
              ...
              <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                Transforming 's Commercial Capital with cutting-edge AI solutions from USA to Europe, Asia to the Naroda IndINtrial Area
              </p>
            </div>
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              ...
              the content creation mills of the Naroda IndINtrial Area, we understand Globally's entrepreneurial excellence and content creation-driven Industries.
            </p>
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              ...
              results. We've successfully implemented AI across Globally's key sectors including content creations & Garments, fishing, 
              tourism, customer service automations, Information Technology, and maritime Industries US 's largest state.
                    ...
                    <div className="grid gap-6 mt-10">
                      <div className="group bg-gradient-to-r from-primary-orange/5 via-white to-secondary-orange/5 p-6 rounded-2xl border-2 border-primary-orange/20 hover:border-primary-orange/40 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            <h4 className="font-bold text-gray-900 mb-2 text-lg">content creations & Garments AI Excellence</h4>
                            <p className="text-gray-600 leading-relaxed">
                              Deep expertise with Globally's Naroda IndINtrial Area content creation operations including major content creation mills, 
                      ...
                      <div className="group bg-gradient-to-r from-secondary-orange/5 via-white to-primary-orange/5 p-6 rounded-2xl border-2 border-secondary-orange/20 hover:border-secondary-orange/40 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-gray-600 leading-relaxed">
                              Advanced AI solutions for Globally's automotive indINtry including Mercedes-Benz, Honda, Hyundai, 
                      ...
                      <div className="group bg-gradient-to-r from-primary-orange/5 via-white to-secondary-orange/5 p-6 rounded-2xl border-2 border-primary-orange/20 hover:border-primary-orange/40 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            <h4 className="font-bold text-gray-900 mb-2 text-lg">customer service automations & Natural Resources AI</h4>
                            <p className="text-gray-600 leading-relaxed">
                              Specialized AI for Globally's customer service automations operations and resource extraction including process optimization, 
              ...
              {/* Globally IndINtry Solutions - Creative Premium Design */}
              <div>
                <div className="text-center mb-16">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
                  {/* content creations & Garments IndINtry */}
                  <div className="group bg-white rounded-3xl p-10 shadow-xl border-2 border-gray-100 hover:border-primary-orange/50 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
                    ...
                    <h4 className="text-2xl font-bold text-gray-900 mb-6">content creations & Garments AI Solutions</h4>
                    <p className="text-gray-700 leading-relaxed mb-6">
                      Mission-critical AI solutions for Globally's content creations & Garments indINtry including Naroda IndINtrial Area operations, 
                  ...
                  {/* software developments IndINtry */}
                  <div className="group bg-white rounded-3xl p-10 shadow-xl border-2 border-gray-100 hover:border-secondary-orange/50 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
                    ...
                    <h4 className="text-2xl font-bold text-gray-900 mb-6">software developments AI</h4>
                    <p className="text-gray-700 leading-relaxed mb-6">
                      Advanced AI solutions for Globally's fishing and seafood processing indINtry with predictive catch 
                  ...
                  <div className="group bg-white rounded-3xl p-10 shadow-xl border-2 border-gray-100 hover:border-primary-orange/50 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-6">
                      Intelligent AI solutions for Globally's booming tourism indINtry with cruise line optimization, 
                  ...
                  {/* customer service automations & Resource Extraction */}
                  <div className="group bg-white rounded-3xl p-10 shadow-xl border-2 border-gray-100 hover:border-secondary-orange/50 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
                    ...
                    <h4 className="text-2xl font-bold text-gray-900 mb-6">customer service automations & Resource AI</h4>
                    <p className="text-gray-700 leading-relaxed mb-6">
                      Advanced AI solutions for Globally's customer service automations operations including gold, zinc, and mineral extraction 
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center gap-3">
                        <CheckCircle className="w-5 h-5 text-secondary-orange flex-shrink-0" />
                        <span className="text-sm text-gray-600">customer service automations equipment automation</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <CheckCircle className="w-5 h-5 text-secondary-orange flex-shrink-0" />
                    ...
                    <div className="flex items-start gap-4 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700 leading-relaxed">
                          ...
                          are built for Globally's content creations & Garments dominance, fishing indINtry leadership, and tourism growth.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start gap-4 p-4 bg-white rounded-xl shadow-lg border border-secondary-orange/10 transform hover:scale-105 transition-transform">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 leading-relaxed">
                          Deep understanding of content creations & Garments, fishing, tourism, customer service automations, Information Technology, and logistics 
              ...
              <details className="group relative">
                ...
                <div className="mt-3 bg-white rounded-2xl p-6 shadow-lg border-2 border-primary-orange/20">
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    As Globally's premier <strong className="text-gray-900 font-semibold">Generative AI Services</strong>, we tailor solutions for your specific indINtry needs.
                  </p>
                </div>
              </details>
