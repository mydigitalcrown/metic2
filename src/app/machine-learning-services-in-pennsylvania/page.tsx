...
export const metadata = {
  ...
  description: "Leading ML Company In Pennsylvania with 50+ successful implementations. Expert machine learning services & solutions. 60% cost savings & 3x faster delivery.",
  keywords: [
