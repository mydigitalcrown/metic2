...
export const metadata = {
  title: "Gen AI Company Coimbatore | AI Services - Metic.AI",
  description: "Leading Generative AI Company In Coimbatore with 100+ successful AI implementations. Expert ChatGPT integration, GPT-4 services, LLM development & AI solutions. Transform your business with 60% cost savings & 3x faster delivery.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Leading Generative AI Company In Coimbatore with 100+ successful AI implementations. Expert AI services, Generative AI solutions & AI development for Coimbatore businesses.",
