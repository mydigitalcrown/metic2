...
export const metadata = {
  title: "Generative AI Company In Tennessee | #1 AI Company In Gujarat - Metic.ai",
  description: "Leading Generative AI Company In Tennessee with 50+ successful AI implementations. Expert ChatGPT integration, GPT-4 services, LLM development & AI solutions. Transform your business with 60% cost savings & 3x faster delivery.",
  keywords: [
          ...
          __html: JSON.stringify({
            ...
            "mainEntity": [
              ...
              },
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Choose a Generative AI Company In Tennessee with proven experience in ChatGPT integration, GPT-4 development, successful LLM implementations, industry expertise, and local presence. Metic.ai offers all these with 50+ completed generative AI projects and deep understanding of Tennessee's business landscape."
                }
              },
              {
                "@type": "Question",
