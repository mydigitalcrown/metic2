...
export const metadata = {
  title: "AI Services New Jersey | Top Artificial Intelligence Solutions & Consulting - Metic.ai",
  description: "Leading AI services in New Jersey. Expert artificial intelligence consulting, machine learning, custom AI development, and data analytics solutions. Transform your NJ business with cutting-edge AI technology.",
  keywords: "AI services New Jersey, artificial intelligence New Jersey, machine learning New Jersey, AI consulting NJ, AI development New Jersey, data science New Jersey, AI solutions NJ, AI companies New Jersey",
  authors: [{ name: "Metic.ai New Jersey AI Team" }],
  robots: "index, follow",
  openGraph: {
    title: "AI Services New Jersey | Top Artificial Intelligence Solutions & Consulting - Metic.ai",
    description: "Leading AI services in New Jersey. Expert artificial intelligence consulting, machine learning, and custom AI development solutions for NJ businesses.",
  ...
  twitter: {
    ...
    title: "AI Services New Jersey | Artificial Intelligence Solutions - Metic.ai",
    description: "Transform your New Jersey business with expert AI services. Machine learning, custom AI development, and data analytics solutions.",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Leading AI services in New Jersey. Expert artificial intelligence consulting, machine learning, custom AI development, and data analytics solutions for NJ businesses.",
            "address": {
              "@type": "PostalAddress",
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center gap-2 mb-6">
              ...
              <span className="text-sm font-medium text-gray-600">Serving New Jersey</span>
            </div>
            
            <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl mb-6">
              AI Services in <span className="text-primary-orange">New Jersey</span>
            </h1>
            
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Transform your New Jersey business with cutting-edge artificial intelligence solutions. 
              From Newark to Jersey City, we deliver enterprise-grade AI services that drive innovation and growth 
