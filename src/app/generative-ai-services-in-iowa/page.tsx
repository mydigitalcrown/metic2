...
export const metadata = {
  title: "Generative AI Company In Iowa | Generative AI Services - Metic.AI",
  description: "Leading Generative AI Company In Iowa with 50+ successful AI implementations. Expert ChatGPT integration, GPT-4 services, LLM development & AI solutions. Transform your business with 60% cost savings & 3x faster delivery.",
  keywords: [
