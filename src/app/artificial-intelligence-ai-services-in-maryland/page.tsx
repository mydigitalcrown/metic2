...
export const metadata = {
  title: "AI Services Maryland | Top Artificial Intelligence Solutions & Consulting - Metic.ai",
  description: "Leading AI services in Maryland. Expert artificial intelligence consulting, machine learning, custom AI development, and data analytics solutions. Transform your MD business with cutting-edge AI technology.",
  keywords: "AI services Maryland, artificial intelligence Maryland, machine learning Maryland, AI consulting MD, AI development Maryland, data science Maryland, AI solutions MD, AI companies Maryland",
  authors: [{ name: "Metic.ai Maryland AI Team" }],
  robots: "index, follow",
  openGraph: {
    title: "AI Services Maryland | Top Artificial Intelligence Solutions & Consulting - Metic.ai",
    description: "Leading AI services in Maryland. Expert artificial intelligence consulting, machine learning, and custom AI development solutions for MD businesses.",
  ...
  twitter: {
    ...
    title: "AI Services Maryland | Artificial Intelligence Solutions - Metic.ai",
    description: "Transform your Maryland business with expert AI services. Machine learning, custom AI development, and data analytics solutions.",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Leading AI services in Maryland. Expert artificial intelligence consulting, machine learning, custom AI development, and data analytics solutions for MD businesses.",
            "address": {
              "@type": "PostalAddress",
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center gap-2 mb-6">
              ...
              <span className="text-sm font-medium text-gray-600">Serving Maryland</span>
            </div>
            
            <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl mb-6">
              AI Services in <span className="text-primary-orange">Maryland</span>
            </h1>
            
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Transform your Maryland business with cutting-edge artificial intelligence solutions. 
              From Baltimore to Annapolis, we deliver enterprise-grade AI services that drive innovation and growth 
