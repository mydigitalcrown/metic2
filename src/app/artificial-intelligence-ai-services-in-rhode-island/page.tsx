...
export const metadata = {
  title: "AI Services Rhode Island | Top Artificial Intelligence Solutions & Consulting - Metic.ai",
  description: "Leading AI services in Rhode Island. Expert artificial intelligence consulting, machine learning, custom AI development, and data analytics solutions. Transform your RI business with cutting-edge AI technology.",
  keywords: "AI services Rhode Island, artificial intelligence Rhode Island, machine learning Rhode Island, AI consulting RI, AI development Rhode Island, data science Rhode Island, AI solutions RI, AI companies Rhode Island",
  ...
  twitter: {
    ...
    title: "AI Services Rhode Island | Artificial Intelligence Solutions - Metic.ai",
    description: "Transform your Rhode Island business with expert AI services. Machine learning, custom AI development, and data analytics solutions.",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Leading AI services in Rhode Island. Expert artificial intelligence consulting, machine learning, custom AI development, and data analytics solutions for RI businesses.",
            "address": {
              "@type": "PostalAddress",
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center gap-2 mb-6">
              ...
              <span className="text-sm font-medium text-gray-600">Serving Rhode Island</span>
            </div>
            
            <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl mb-6">
              AI Services in <span className="text-primary-orange">Rhode Island</span>
            </h1>
            
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Transform your Rhode Island business with cutting-edge artificial intelligence solutions. 
              From Providence to Newport, we deliver enterprise-grade AI services that drive growth and innovation 
