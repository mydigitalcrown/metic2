    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "AI Services Chennai - Metic.ai",
      },
    ],
  },
  twitter: {
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "areaServed": [
              ...
              "OMR", "Tambaram", "Porur", "Chrompet", "Mylapore",
              "Guindy", "Egmore", "Mount Road", "Marina", "Besant Nagar"
            ],
            "aggregateRating": {
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
              Join leading Chennai companies that trust Metic.ai for their AI transformation. 
            ...
            <div className="mt-12 text-center">
              <p className="text-orange-200 mb-4">Trusted by businesses across Chennai</p>
