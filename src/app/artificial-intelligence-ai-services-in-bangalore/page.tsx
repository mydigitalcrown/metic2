    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "AI Services Bangalore - Metic.ai",
      },
    ],
  },
  twitter: {
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center gap-2 mb-6">
              ...
              <span className="text-sm font-medium text-gray-600">Serving Bangalore, Karnataka</span>
            </div>
            
            <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl mb-6">
              AI Services in <span className="text-primary-orange">Bangalore</span>
            </h1>
            
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Transform your Bangalore business with cutting-edge artificial intelligence solutions. 
              From Electronic City to Whitefield, we deliver enterprise-grade AI services that drive innovation and growth 
              across India's Silicon Valley.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="container px-4 md:px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl mb-6">
                Why Bangalore Businesses Choose Metic.ai
              </h2>
              <div className="w-20 h-1 bg-primary-orange mx-auto mb-8"></div>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Trusted by businesses across Bangalore for our expertise, results, and commitment to success.
              </p>
            </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
              Join leading Bangalore companies that trust Metic.ai for their AI transformation. 
            ...
            <div className="mt-12 text-center">
              <p className="text-orange-200 mb-4">Trusted by businesses across Bangalore</p>
