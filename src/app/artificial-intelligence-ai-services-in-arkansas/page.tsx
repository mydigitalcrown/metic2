...
export const metadata = {
  title: "AI Services Arkansas | Premier Artificial Intelligence Solutions & Development - Metic.ai",
  description: "Arkansas's leading AI company delivering custom artificial intelligence solutions. Expert AI development, machine learning, automation, and data analytics with 3x faster delivery and 60% cost savings for AR businesses.",
  keywords: "AI services Arkansas, artificial intelligence Arkansas, machine learning Arkansas, AI consulting AR, AI development Arkansas, custom AI solutions AR, AI automation Arkansas, enterprise AI Arkansas, Little Rock AI, Fayetteville AI",
  ...
  twitter: {
    ...
    title: "AI Services Arkansas | Premier Artificial Intelligence Solutions & Development - Metic.ai",
    description: "Arkansas's leading AI company delivering custom artificial intelligence solutions. Expert AI development, machine learning, automation, and data analytics with 3x faster delivery and 60% cost savings.",
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center gap-2 mb-6">
              ...
              <span className="text-sm font-medium text-orange-300">Serving Arkansas</span>
            </div>
            
            <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl mb-6 text-white">
              AI That Works in <span className="text-primary-orange">Arkansas</span>
            </h1>
            
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              From Little Rock's financial sector to Bentonville's retail giants, Arkansas businesses 
              expect practical solutions. We've helped 85+ Arkansas companies implement AI that delivers 
              real results without the complexity. Natural state, smart technology.
            </p>
