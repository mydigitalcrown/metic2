...
export const metadata = {
  title: "Machine Learning Services in Florida | ML Solutions & Model Development - Metic.ai",
  description: "Professional machine learning services in Florida including predictive analytics, classification models, regression analysis, clustering, neural networks, and enterprise ML solutions. 3x faster delivery and 60% cost savings.",
  keywords: "machine learning services Florida, predictive analytics Florida, classification models Florida, regression analysis Florida, neural networks Florida, ML model development Florida, data science Florida, artificial intelligence Florida, predictive modeling Florida, supervised learning Florida, unsupervised learning Florida",
  authors: [{ name: "Metic.ai Machine Learning Team" }],
  robots: "index, follow",
  openGraph: {
    title: "Machine Learning Services in Florida | ML Solutions & Model Development - Metic.ai",
    description: "Professional machine learning services in Florida including predictive analytics, classification models, and enterprise ML solutions. 3x faster delivery and 60% cost savings.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Machine Learning Services in Florida by Metic.ai",
      },
    ],
  },
  alternates: {
    ...
    <>
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl mb-6">
              <span className="text-primary-orange">Machine Learning Services</span> in Florida
            </h1>
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Transform your Florida business with advanced machine learning solutions. From predictive 
      ...
      <section id="consultation" className="py-20 bg-primary-orange text-white">
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl mb-6">
              Ready to Transform Your Florida Business with Machine Learning?
            </h2>
            <p className="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
              Join leading Florida companies leveraging our advanced machine learning solutions. 
