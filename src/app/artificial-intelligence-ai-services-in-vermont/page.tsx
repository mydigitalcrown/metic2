...
export const metadata = {
  title: "AI Services Vermont | Top Artificial Intelligence Solutions & Consulting - Metic.ai",
  description: "Leading AI services in Vermont. Expert artificial intelligence consulting, machine learning, custom AI development, and data analytics solutions. Transform your VT business with cutting-edge AI technology.",
  keywords: "AI services Vermont, artificial intelligence Vermont, machine learning Vermont, AI consulting VT, AI development Vermont, data science Vermont, AI solutions VT, AI companies Vermont",
  authors: [{ name: "Metic.ai Vermont AI Team" }],
  robots: "index, follow",
  openGraph: {
    title: "AI Services Vermont | Top Artificial Intelligence Solutions & Consulting - Metic.ai",
    description: "Leading AI services in Vermont. Expert artificial intelligence consulting, machine learning, and custom AI development solutions for VT businesses.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "AI Services Vermont - Metic.ai",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "AI Services Vermont | Artificial Intelligence Solutions - Metic.ai",
    description: "Transform your Vermont business with expert AI services. Machine learning, custom AI development, and data analytics solutions.",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Metic.ai - AI Services Vermont",
            "image": "https://metic.ai/logo.png",
            "description": "Leading AI services in Vermont. Expert artificial intelligence consulting, machine learning, custom AI development, and data analytics solutions for VT businesses.",
            "address": {
              "@type": "PostalAddress",
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center gap-2 mb-6">
              ...
              <span className="text-sm font-medium text-gray-600">Serving Vermont</span>
            </div>
            
            <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl mb-6">
              AI Services in <span className="text-primary-orange">Vermont</span>
            </h1>
            
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Transform your Vermont business with cutting-edge artificial intelligence solutions. 
              From Burlington to Montpelier, we deliver enterprise-grade AI services that drive growth and innovation 
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
              Join leading Vermont companies that trust Metic.ai for their AI transformation. 
