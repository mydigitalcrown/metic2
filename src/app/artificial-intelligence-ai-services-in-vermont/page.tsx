...
export const metadata = {
  title: "AI Services Vermont | Premier Artificial Intelligence Solutions & Development - Metic.ai",
  description: "Vermont's leading AI company delivering custom artificial intelligence solutions. Expert AI development, machine learning, automation, and data analytics with 3x faster delivery and 60% cost savings for VT businesses.",
  keywords: "AI services Vermont, artificial intelligence Vermont, machine learning Vermont, AI consulting VT, AI development Vermont, custom AI solutions VT, AI automation Vermont, enterprise AI Vermont, Burlington AI, Montpelier AI",
  ...
  twitter: {
    ...
    title: "AI Services Vermont | Premier Artificial Intelligence Solutions & Development - Metic.ai",
    description: "Vermont's leading AI company delivering custom artificial intelligence solutions. Expert AI development, machine learning, automation, and data analytics with 3x faster delivery and 60% cost savings.",
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl mb-6 text-white">
              AI Solutions for <span className="text-primary-orange">Vermont</span>
            </h1>
            
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Vermont businesses value craftsmanship and quality over quantity. From Burlington's tech scene 
              to artisan manufacturers across the Green Mountains, we've helped 20+ Vermont companies implement 
              AI that enhances their careful, thoughtful approach to business. Green Mountain innovation meets smart technology.
            </p>
