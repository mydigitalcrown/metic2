...
export const metadata = {
  title: "Machine Learning Services in Arizona | ML Solutions & Model Development - Metic.ai",
  description: "Professional machine learning services in Arizona including predictive analytics, classification models, regression analysis, clustering, neural networks, and enterprise ML solutions. 3x faster delivery and 60% cost savings.",
  keywords: "machine learning services Arizona, predictive analytics Arizona, classification models Arizona, regression analysis Arizona, neural networks Arizona, ML model development Arizona, data science Arizona, artificial intelligence Arizona, predictive modeling Arizona, supervised learning Arizona, unsupervised learning Arizona",
  authors: [{ name: "Metic.ai Machine Learning Team" }],
  robots: "index, follow",
  openGraph: {
    title: "Machine Learning Services in Arizona | ML Solutions & Model Development - Metic.ai",
    description: "Professional machine learning services in Arizona including predictive analytics, classification models, and enterprise ML solutions. 3x faster delivery and 60% cost savings.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Machine Learning Services in Arizona by Metic.ai",
      },
    ],
  },
  alternates: {
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl mb-6">
              <span className="text-primary-orange">Machine Learning Services</span> in Arizona
            </h1>
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Transform your Arizona business with advanced machine learning solutions. From predictive 
