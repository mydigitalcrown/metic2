...
export const metadata = {
  title: "Gen AI Company Oregon | AI Services - Metic.AI",
  description: "Leading Generative AI Company In Oregon with 100+ successful AI implementations. Expert ChatGPT integration, GPT-4 services, LLM development & AI solutions. Transform your business with 60% cost savings & 3x faster delivery.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Leading Generative AI Company In Oregon with 100+ successful AI implementations. Expert AI services, Generative AI solutions & AI development for Oregon businesses.",
          ...
          __html: JSON.stringify({
            ...
            "mainEntity": [
              ...
              },
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Choose a Generative AI Company In Oregon with proven experience in ChatGPT integration, GPT-4 development, successful LLM implementations, Industry expertise, and local presence. Metic.ai offers all these with 100+ completed generative AI projects and deep understanding of Oregon's business landscape."
                }
              },
              {
                "@type": "Question",
